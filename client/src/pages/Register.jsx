        ...
        <div className='w-screen h-screen bg-green-50/60 flex flex-col justify-center items-center'>
            <div className='shadow-lg shadow-green-100 flex flex-col justify-center rounded-md bg-white h-[90%] p-4  px-[60px] w-[420px] '>
                <div className='flex flex-col items-center'>
                    <img src='/logo.jpg' className='w-[60px] h-[60px]' />
                ...
                <form onSubmit={(e) => handleRegister(e)} className='flex flex-col items-center  space-y-[6px] '>
                    ...
                    <button type="submit" className='flex items-center justify-center text-center text-neutral-100 font-bold bg-green-600 p-2 w-full rounded-md shadow-md'>Register</button>
                    {
                        err !== null ?
                ...
                <div className='flex flex-col text-center text-neutral-400 text-[13px] justify-center  space-x-2 mt-4' >
                    ...
                    <p className='text-center'><a className='text-green-500'>Terms of Service </a>and <a className='text-green-500'>Privacy Policy</a>.</p>
